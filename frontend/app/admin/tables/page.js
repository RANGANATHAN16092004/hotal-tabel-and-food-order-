    ...
    <AdminLayout>
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">Tables Management</h1>
          <button
            onClick={() => {
              setEditingTable(null);
              setFormData({ tableNumber: '', capacity: '', status: 'available' });
              ...
              <div key={table._id} className="bg-white rounded-lg shadow-md p-6">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <p className="text-green-600 mt-1 font-medium">Capacity: {table.capacity} guests</p>
                  </div>
