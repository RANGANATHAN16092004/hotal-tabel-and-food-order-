    ...
    <AdminLayout>
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <h1 className="text-3xl font-bold bg-gradient-to-r from-yellow-600 to-orange-600 bg-clip-text text-transparent">Orders Management</h1>
        </div>
                  ...
                  {orders.map((order) => (
                    <tr key={order._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        <span className="font-semibold text-indigo-700">{order.customerId?.name || 'N/A'}</span>
                        <br />
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-semibold text-blue-700">#{selectedOrder._id.slice(-6)}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    <p className="text-sm text-indigo-600 font-medium">Customer</p>
                  ...
                  <div>
                    <p className="text-sm text-teal-600 font-medium">Date</p>
                    <p className="font-semibold text-teal-700">{formatDate(selectedOrder.orderDate)}</p>
                  </div>
                  <div>
                      ...
                      >
                        <div>
                          ...
                          <p className="text-sm text-blue-600">
                            Quantity: <span className="font-semibold">{item.quantity}</span> × <span className="text-green-600">${parseFloat(item.price).toFixed(2)}</span>
                          </p>
                        </div>
