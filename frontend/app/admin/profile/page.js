    ...
    <AdminLayout>
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <h1 className="text-3xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Profile</h1>
          <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-semibold text-purple-700 mb-4">Hotel Information</h2>
            <div className="space-y-4">
              <div>
                <p className="text-sm text-blue-600 font-medium">Hotel Name</p>
              ...
              <div>
                <p className="text-sm text-indigo-600 font-medium">Phone</p>
                <p className="text-lg font-semibold text-gray-900">{hotel?.phone}</p>
              </div>
              {hotel?.address && (
                <div>
                  <p className="text-sm text-teal-600 font-medium">Address</p>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-semibold text-pink-700 mb-4">QR Code</h2>
