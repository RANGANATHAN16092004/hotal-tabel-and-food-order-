  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 px-4 py-8">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
        <h1 className="text-3xl font-bold text-center bg-gradient-to-r from-green-600 to-teal-600 bg-clip-text text-transparent mb-6">
          Hotel Registration
        </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="address" className="block text-sm font-medium text-teal-700 mb-1">
              Address
            </label>
            <input
              type="text"
        ...
        <p className="mt-4 text-center text-sm text-gray-600">
          ...
          <Link href="/admin/login" className="text-green-600 hover:text-green-800 font-semibold hover:underline">
            Login here
          </Link>
        </p>
      </div>
